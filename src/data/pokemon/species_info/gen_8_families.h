...
const struct SpeciesInfo gSpeciesInfoGen8[] =
{
    ...
    [SPECIES_CORVIKNIGHT] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_MIRROR_ARMOR },
    ...
    [SPECIES_CLOBBOPUS] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 25, SPECIES_GRAPPLOCT}),
    },
    ...
    [SPECIES_HATTREM] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY),
        .abilities = { ABILITY_MAGIC_BOUNCE, ABILITY_NONE, ABILITY_ANTICIPATION  },
        .bodyColor = BODY_COLOR_PINK,
