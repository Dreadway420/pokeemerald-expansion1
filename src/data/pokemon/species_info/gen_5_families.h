...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_VICTINI] =
    {
        ...
        .catchRate = 100,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 399 : 359,
        .evYield_HP = 0,
    ...
    [SPECIES_TEPIG] =
    {
        ...
        .abilities = { ABILITY_FUR_COAT, ABILITY_NONE, ABILITY_THICK_FAT },
    ...
    [SPECIES_EMBOAR] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_FUR_COAT, ABILITY_NONE, ABILITY_RECKLESS },
        .bodyColor = BODY_COLOR_RED,
        .noFlip = TRUE,
    ...
    [SPECIES_MUNNA] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_FOREWARN, ABILITY_TELEPATHY, ABILITY_SYNCHRONIZE },
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 39, SPECIES_MUSHARNA}),
    },
    ...
    [SPECIES_GIGALITH] =
    {
        ...
        .baseSpeed     = 25,
        .baseSpAttack  = 60,
        .baseSpDefense = P_UPDATED_STATS >= GEN_6 ? 90 : 90,
        .types = MON_TYPES(TYPE_ROCK),
        .catchRate = 100,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 258,
    ...
    [SPECIES_WOOBAT] =
    {
        ...
        .catchRate = 190,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 86 : 83,
        .evYield_Speed = 0,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 15,
        .friendship = STANDARD_FRIENDSHIP,
    ...
    [SPECIES_CONKELDURR] =
    {
        ...
        .types = MON_TYPES(TYPE_FIGHTING),
        .catchRate = 100,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 336 : 301,
        .evYield_Attack = 0,
        .genderRatio = PERCENT_FEMALE(25),
        .eggCycles = 20,
        .friendship = STANDARD_FRIENDSHIP,
...
#define COTTONEE_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_GRASS)
    ...
    [SPECIES_PETILIL] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 30, SPECIES_LILLIGANT, CONDITIONS({IF_LOW_KEY_NATURE})},
                                {EVO_LEVEL, 30, SPECIES_LILLIGANT_HISUI, CONDITIONS({IF_AMPED_NATURE})}),
    },
    ...
    [SPECIES_KROOKODILE] =
    {
        .baseHP        = 95,
        .baseAttack    = 117,
        .baseDefense   = P_UPDATED_STATS >= GEN_6 ? 90 : 90,
        .baseSpeed     = 92,
        .baseSpAttack  = 65,
        .baseSpDefense = 85,
        .types = MON_TYPES(TYPE_GROUND, TYPE_DARK),
    ...
    [SPECIES_DARMANITAN_STANDARD] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_ZEN_MODE, ABILITY_ZEN_MODE, ABILITY_SHEER_FORCE },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_GOTHITELLE] =
    {
        ...
        .types = MON_TYPES(TYPE_PSYCHIC),
        .catchRate = 100,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 325 : 293,
        .evYield_SpDefense = 0,
        .genderRatio = PERCENT_FEMALE(75),
        .eggCycles = 20,
        .friendship = STANDARD_FRIENDSHIP,
    ...
    [SPECIES_VANILLUXE] =
    {
        ...
        .types = MON_TYPES(TYPE_ICE),
        .catchRate = 100,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 356 : 320,
        .evYield_SpAttack = 0,
    ...
    [SPECIES_KLINKLANG] =
    {
        ...
        .types = MON_TYPES(TYPE_STEEL),
        .catchRate = 100,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 345 : 311,
        .evYield_Defense = 0,
        .genderRatio = MON_GENDERLESS,
        .eggCycles = 20,
        .friendship = STANDARD_FRIENDSHIP,
    ...
    [SPECIES_TYNAMO] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 19, SPECIES_EELEKTRIK}),
    },
    ...
    [SPECIES_EELEKTRIK] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 43, SPECIES_EELEKTROSS}),
    },
    ...
    [SPECIES_EELEKTROSS] =
    {
        ...
        .types = MON_TYPES(TYPE_ELECTRIC),
        .catchRate = 100,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 343 : 308,
        .evYield_Attack = 0,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 20,
        .friendship = STANDARD_FRIENDSHIP,
    ...
    [SPECIES_LAMPENT] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 38, SPECIES_CHANDELURE}),
    },
    ...
    [SPECIES_AXEW] =
    {
        ...
        .abilities = { ABILITY_MOLD_BREAKER },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Axew"),
        .cryId = CRY_AXEW,
    ...
    [SPECIES_HAXORUS] =
    {
        ...
        .types = MON_TYPES(TYPE_DRAGON),
        .catchRate = 100,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 359 : 323,
        .evYield_Attack = 0,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 40,
        .friendship = 35,
    ...
    [SPECIES_BEARTIC] =
    {
        ...
        .types = MON_TYPES(TYPE_ICE),
        .catchRate = 100,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 235 : 226,
        .evYield_Attack = 0,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 20,
        .friendship = STANDARD_FRIENDSHIP,
    ...
    [SPECIES_CRYOGONAL] =
    {
        ...
        .types = MON_TYPES(TYPE_ICE),
        .catchRate = 100,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 239 : 226,
        .evYield_SpDefense = 0,
        .itemRare = ITEM_NEVER_MELT_ICE,
        .genderRatio = MON_GENDERLESS,
        .eggCycles = 25,
    ...
    [SPECIES_PAWNIARD] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 29, SPECIES_BISHARP}),
    },
    ...
    [SPECIES_BISHARP] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_DEFIANT, ABILITY_SUPREME_OVERLORD, ABILITY_SUPREME_OVERLORD },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_RUFFLET] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 35, SPECIES_BRAVIARY_HISUI},
                                {EVO_ITEM, ITEM_SUN_STONE, SPECIES_BRAVIARY}),
    },
    ...
    [SPECIES_VOLCARONA] =
    {
        ...
        .types = MON_TYPES(TYPE_BUG, TYPE_FIRE),
        .catchRate = 15,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 365 : 329,
        .evYield_SpAttack = 0,
    ...
    [SPECIES_COBALION] =
    {
        ...
        .catchRate = 100,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 385 : 347,
        .evYield_Defense = 0,
        .genderRatio = MON_GENDERLESS,
        .eggCycles = 80,
        .friendship = 35,
    ...
    [SPECIES_RESHIRAM] =
    {
        ...
        .catchRate = 100,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 452 : 406,
        .evYield_SpAttack = 0,
        .genderRatio = MON_GENDERLESS,
        .eggCycles = 120,
        .friendship = 0,
    ...
    [SPECIES_KYUREM] =
    {
        ...
        .catchRate = 100,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 438 : 395,
        .evYield_HP = 0,
        .evYield_Attack = 0,
        .evYield_SpAttack = 0,
        .genderRatio = MON_GENDERLESS,
