...
const struct SpeciesInfo gSpeciesInfoGen4[] =
{
    ...
    [SPECIES_STARLY] =
    {
        ...
        .catchRate = 255,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 42 : 49,
        .evYield_Speed = 0,
    ...
    [SPECIES_STARAVIA] =
    {
        ...
        .types = MON_TYPES(TYPE_NORMAL, TYPE_FLYING),
        .catchRate = 120,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 105 : 99,
        .evYield_Speed = 0,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 15,
        .friendship = STANDARD_FRIENDSHIP,
    ...
    [SPECIES_BIDOOF] =
    {
        ...
        .catchRate = 255,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 43 : 50,
        .evYield_HP = 0,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 15,
        .friendship = STANDARD_FRIENDSHIP,
    ...
    [SPECIES_KRICKETOT] =
    {
        ...
        .catchRate = 255,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 34 : 47,
        .evYield_Defense = 0,
    ...
    [SPECIES_KRICKETUNE] =
    {
        ...
        .types = MON_TYPES(TYPE_BUG),
        .catchRate = 70,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 118 : 140,
        .evYield_Attack = 0,
        .itemRare = ITEM_METRONOME,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 15,
    ...
    [SPECIES_SHINX] =
    {
        ...
        .catchRate = 235,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 46 : 53,
        .evYield_Attack = 0,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 20,
        .friendship = STANDARD_FRIENDSHIP,
    ...
    [SPECIES_LUXIO] =
    {
        ...
        .catchRate = 120,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 111 : 103,
        .evYield_Attack = 0,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 20,
        .friendship = 100,
    ...
    [SPECIES_WORMADAM_PLANT] =
    {
        ...
        .catchRate = 70,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 130 : 140,
        .evYield_SpDefense = 0,
...
#define MOTHIM_SPECIES_INFO                                                 \
    ...
    [SPECIES_COMBEE] =
    {
        ...
        .types = MON_TYPES(TYPE_BUG, TYPE_FLYING),
        .catchRate = 120,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 42 : 55,
        .evYield_Speed = 0,
        .itemRare = ITEM_HONEY,
    ...
    [SPECIES_VESPIQUEN] =
    {
        ...
        .types = MON_TYPES(TYPE_BUG, TYPE_FLYING),
        .catchRate = 70,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 146 : 166,
        .evYield_Defense = 0,
        .evYield_SpDefense = 0,
    ...
    [SPECIES_BUIZEL] =
    {
        ...
        .types = MON_TYPES(TYPE_WATER),
        .catchRate = 190,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 58 : 66,
        .evYield_Speed = 0,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 20,
        .friendship = STANDARD_FRIENDSHIP,
    ...
    [SPECIES_FLOATZEL] =
    {
        ...
        .types = MON_TYPES(TYPE_WATER),
        .catchRate = 75,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 152 : 156,
        .evYield_Speed = 0,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 20,
        .friendship = STANDARD_FRIENDSHIP,
    ...
    [SPECIES_CHERUBI] =
    {
        ...
        .types = MON_TYPES(TYPE_GRASS),
        .catchRate = 190,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 47 : 59,
        .evYield_SpAttack = 0,
    ...
    [SPECIES_CHERRIM_OVERCAST] =
    {
        ...
        .types = MON_TYPES(TYPE_GRASS),
        .catchRate = 75,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 139 : 117,
        .evYield_SpAttack = 0,
        .itemRare = ITEM_MIRACLE_SEED,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 20,
    ...
    [SPECIES_SHELLOS_WEST] =
    {
        ...
        .types = MON_TYPES(TYPE_WATER),
        .catchRate = 190,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 57 : 63,
        .evYield_HP = 0,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 20,
        .friendship = STANDARD_FRIENDSHIP,
    ...
    [SPECIES_DRIFLOON] =
    {
        ...
        .catchRate = 125,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 61 : 111,
        .evYield_HP = 0,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 30,
        .friendship = STANDARD_FRIENDSHIP,
    ...
    [SPECIES_LOPUNNY] =
    {
        ...
        .catchRate = 70,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 148 : 156,
        .evYield_Speed = 0,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 20,
        .friendship = 140,
    ...
    [SPECIES_GLAMEOW] =
    {
        ...
        .types = MON_TYPES(TYPE_NORMAL),
        .catchRate = 190,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 54 : 62,
        .evYield_Speed = 0,
    ...
    [SPECIES_PURUGLY] =
    {
        ...
        .types = MON_TYPES(TYPE_NORMAL),
        .catchRate = 75,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 139 : 162,
        .evYield_Speed = 0,
        .genderRatio = PERCENT_FEMALE(75),
        .eggCycles = 20,
        .friendship = STANDARD_FRIENDSHIP,
    ...
    [SPECIES_SKUNTANK] =
    {
        ...
        .types = MON_TYPES(TYPE_POISON, TYPE_DARK),
        .catchRate = 70,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 148 : 184,
        .evYield_HP = 0,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 20,
        .friendship = STANDARD_FRIENDSHIP,
    ...
    [SPECIES_BRONZOR] =
    {
        ...
        .catchRate = 255,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 53 : 63,
        .evYield_Defense = 0,
    ...
    [SPECIES_BRONZONG] =
    {
        ...
        .types = MON_TYPES(TYPE_STEEL, TYPE_PSYCHIC),
        .catchRate = 90,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 154 : 166,
        .evYield_Defense = 0,
        .evYield_SpDefense = 0,
        .itemRare = ITEM_METAL_COAT,
        .genderRatio = MON_GENDERLESS,
    ...
    [SPECIES_CHATOT] =
    {
        ...
        .types = MON_TYPES(TYPE_NORMAL, TYPE_FLYING),
        .catchRate = 70,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 127 : 94,
        .evYield_Attack = 0,
        .itemRare = ITEM_METRONOME,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 20,
    ...
    [SPECIES_SPIRITOMB] =
    {
        ...
        .catchRate = 100,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 150 : 148,
        .evYield_Defense = 0,
        .evYield_SpDefense = 0,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 30,
    ...
    [SPECIES_GIBLE] =
    {
        ...
        .abilities = { ABILITY_ROUGH_SKIN, ABILITY_NONE, ABILITY_SAND_FORCE },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Gible"),
        .cryId = CRY_GIBLE,
    ...
    [SPECIES_LUCARIO] =
    {
        ...
        .catchRate = 70,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 162 : 180,
        .evYield_Attack = 0,
        .evYield_SpAttack = 0,
        .genderRatio = PERCENT_FEMALE(12.5),
        .eggCycles = 25,
    ...
    [SPECIES_HIPPOPOTAS] =
    {
        ...
        .catchRate = 140,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 58 : 83,
        .evYield_Defense = 0,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 30,
        .friendship = STANDARD_FRIENDSHIP,
    ...
    [SPECIES_CROAGUNK] =
    {
        ...
        .catchRate = 140,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 53 : 73,
        .evYield_Attack = 0,
    ...
    [SPECIES_TOXICROAK] =
    {
        ...
        .types = MON_TYPES(TYPE_POISON, TYPE_FIGHTING),
        .catchRate = 75,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 151 : 159,
        .evYield_Attack = 0,
        .itemRare = ITEM_BLACK_SLUDGE,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 20,
    ...
    [SPECIES_CARNIVINE] =
    {
        ...
        .types = MON_TYPES(TYPE_GRASS),
        .catchRate = 200,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 140 : 144,
        .evYield_Attack = 0,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 25,
        .friendship = STANDARD_FRIENDSHIP,
    ...
    [SPECIES_SNOVER] =
    {
        ...
        .catchRate = 120,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 58 : 115,
        .evYield_Attack = 0,
