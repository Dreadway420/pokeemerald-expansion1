...
const struct SpeciesInfo gSpeciesInfoGen4[] =
{
    ...
    [SPECIES_STARLY] =
    {
        ...
        .catchRate = 255,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 32 : 37,
        .evYield_Speed = 0,
    ...
    [SPECIES_STARAVIA] =
    {
        ...
        .types = MON_TYPES(TYPE_NORMAL, TYPE_FLYING),
        .catchRate = 120,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 79 : 75,
        .evYield_Speed = 0,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 15,
        .friendship = STANDARD_FRIENDSHIP,
    ...
    [SPECIES_BIDOOF] =
    {
        ...
        .catchRate = 255,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 33 : 38,
        .evYield_HP = 0,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 15,
        .friendship = STANDARD_FRIENDSHIP,
    ...
    [SPECIES_KRICKETOT] =
    {
        ...
        .catchRate = 255,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 26 : 36,
        .evYield_Defense = 0,
    ...
    [SPECIES_KRICKETUNE] =
    {
        ...
        .types = MON_TYPES(TYPE_BUG),
        .catchRate = 70,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 89 : 106,
        .evYield_Attack = 0,
        .itemRare = ITEM_METRONOME,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 15,
    ...
    [SPECIES_SHINX] =
    {
        ...
        .catchRate = 235,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 35 : 40,
        .evYield_Attack = 0,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 20,
        .friendship = STANDARD_FRIENDSHIP,
        ...
        .abilities = { ABILITY_GALVANIZE, ABILITY_INTIMIDATE },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Shinx"),
        .cryId = CRY_SHINX,
    ...
    [SPECIES_LUXIO] =
    {
        ...
        .catchRate = 120,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 84 : 78,
        .evYield_Attack = 0,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 20,
        .friendship = 100,
    ...
    [SPECIES_CRANIDOS] =
    {
        ...
        .catchRate = 70,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 46 : 66,
        .evYield_Attack = 0,
        .genderRatio = PERCENT_FEMALE(12.5),
        .eggCycles = 30,
        .friendship = STANDARD_FRIENDSHIP,
    ...
    [SPECIES_RAMPARDOS] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_ROCK_HEAD, ABILITY_SHEER_FORCE, ABILITY_MOLD_BREAKER },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_BASTIODON] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_STAMINA, ABILITY_STAMINA, ABILITY_STURDY },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_BURMY_PLANT_CLOAK] =
    {
        ...
        .types = MON_TYPES(TYPE_BUG),
        .catchRate = 120,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 30 : 40,
        .evYield_SpDefense = 0,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 15,
        .friendship = STANDARD_FRIENDSHIP,
    ...
    [SPECIES_WORMADAM_PLANT_CLOAK] =
    {
        ...
        .catchRate = 70,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 98 : 106,
        .evYield_SpDefense = 0,
...
#define MOTHIM_SPECIES_INFO                                                 \
    ...
    [SPECIES_COMBEE] =
    {
        ...
        .types = MON_TYPES(TYPE_BUG, TYPE_FLYING),
        .catchRate = 120,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 32 : 42,
        .evYield_Speed = 0,
        .itemRare = ITEM_HONEY,
    ...
    [SPECIES_VESPIQUEN] =
    {
        ...
        .types = MON_TYPES(TYPE_BUG, TYPE_FLYING),
        .catchRate = 70,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 110 : 125,
        .evYield_Defense = 0,
        .evYield_SpDefense = 0,
    ...
    [SPECIES_BUIZEL] =
    {
        ...
        .types = MON_TYPES(TYPE_WATER),
        .catchRate = 190,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 44 : 50,
        .evYield_Speed = 0,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 20,
        .friendship = STANDARD_FRIENDSHIP,
    ...
    [SPECIES_FLOATZEL] =
    {
        ...
        .types = MON_TYPES(TYPE_WATER),
        .catchRate = 75,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 115 : 118,
        .evYield_Speed = 0,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 20,
        .friendship = STANDARD_FRIENDSHIP,
    ...
    [SPECIES_CHERUBI] =
    {
        ...
        .types = MON_TYPES(TYPE_GRASS),
        .catchRate = 190,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 36 : 45,
        .evYield_SpAttack = 0,
    ...
    [SPECIES_CHERRIM_OVERCAST] =
    {
        ...
        .types = MON_TYPES(TYPE_GRASS),
        .catchRate = 75,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 105 : 88,
        .evYield_SpAttack = 0,
        .itemRare = ITEM_MIRACLE_SEED,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 20,
    ...
    [SPECIES_SHELLOS_WEST_SEA] =
    {
        ...
        .types = MON_TYPES(TYPE_WATER),
        .catchRate = 190,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 43 : 48,
        .evYield_HP = 0,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 20,
        .friendship = STANDARD_FRIENDSHIP,
    ...
    [SPECIES_DRIFLOON] =
    {
        ...
        .catchRate = 125,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 46 : 84,
        .evYield_HP = 0,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 30,
        .friendship = STANDARD_FRIENDSHIP,
    ...
    [SPECIES_BUNEARY] =
    {
        ...
        .types = MON_TYPES(TYPE_NORMAL),
        .catchRate = 190,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 46 : 56,
        .evYield_Speed = 0,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 20,
        .friendship = 0,
    ...
    [SPECIES_LOPUNNY] =
    {
        ...
        .catchRate = 70,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 112 : 118,
        .evYield_Speed = 0,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 20,
        .friendship = 140,
    ...
    [SPECIES_GLAMEOW] =
    {
        ...
        .types = MON_TYPES(TYPE_NORMAL),
        .catchRate = 190,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 41 : 47,
        .evYield_Speed = 0,
    ...
    [SPECIES_PURUGLY] =
    {
        ...
        .types = MON_TYPES(TYPE_NORMAL),
        .catchRate = 75,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 105 : 122,
        .evYield_Speed = 0,
        .genderRatio = PERCENT_FEMALE(75),
        .eggCycles = 20,
        .friendship = STANDARD_FRIENDSHIP,
    ...
    [SPECIES_SKUNTANK] =
    {
        ...
        .types = MON_TYPES(TYPE_POISON, TYPE_DARK),
        .catchRate = 70,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 112 : 139,
        .evYield_HP = 0,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 20,
        .friendship = STANDARD_FRIENDSHIP,
    ...
    [SPECIES_BRONZOR] =
    {
        ...
        .catchRate = 255,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 40 : 48,
        .evYield_Defense = 0,
    ...
    [SPECIES_BRONZONG] =
    {
        ...
        .types = MON_TYPES(TYPE_STEEL, TYPE_PSYCHIC),
        .catchRate = 90,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 116 : 125,
        .evYield_Defense = 0,
        .evYield_SpDefense = 0,
        .itemRare = ITEM_METAL_COAT,
        .genderRatio = MON_GENDERLESS,
    ...
    [SPECIES_CHATOT] =
    {
        ...
        .types = MON_TYPES(TYPE_NORMAL, TYPE_FLYING),
        .catchRate = 70,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 96 : 71,
        .evYield_Attack = 0,
        .itemRare = ITEM_METRONOME,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 20,
    ...
    [SPECIES_SPIRITOMB] =
    {
        ...
        .catchRate = 100,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 113 : 112,
        .evYield_Defense = 0,
        .evYield_SpDefense = 0,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 30,
    ...
    [SPECIES_LUCARIO] =
    {
        ...
        .catchRate = 70,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 122 : 136,
        .evYield_Attack = 0,
        .evYield_SpAttack = 0,
        .genderRatio = PERCENT_FEMALE(12.5),
        .eggCycles = 25,
    ...
    [SPECIES_HIPPOPOTAS] =
    {
        ...
        .catchRate = 140,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 44 : 63,
        .evYield_Defense = 0,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 30,
        .friendship = STANDARD_FRIENDSHIP,
    ...
    [SPECIES_CROAGUNK] =
    {
        ...
        .catchRate = 140,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 40 : 55,
        .evYield_Attack = 0,
        ...
        .abilities = { ABILITY_MERCILESS, ABILITY_NONE, ABILITY_DRY_SKIN },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_TOXICROAK] =
    {
        ...
        .types = MON_TYPES(TYPE_POISON, TYPE_FIGHTING),
        .catchRate = 75,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 114 : 120,
        .evYield_Attack = 0,
        .itemRare = ITEM_BLACK_SLUDGE,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 20,
    ...
    [SPECIES_CARNIVINE] =
    {
        ...
        .types = MON_TYPES(TYPE_GRASS),
        .catchRate = 200,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 106 : 109,
        .evYield_Attack = 0,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 25,
        .friendship = STANDARD_FRIENDSHIP,
    ...
    [SPECIES_SNOVER] =
    {
        ...
        .catchRate = 120,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 44 : 87,
        .evYield_Attack = 0,
    ...
    [SPECIES_ABOMASNOW] =
    {
        ...
        .types = MON_TYPES(TYPE_GRASS, TYPE_ICE),
        .catchRate = 70,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 115 : 142,
        .evYield_Attack = 0,
        .evYield_SpAttack = 0,
        .itemRare = ITEM_NEVER_MELT_ICE,
        .genderRatio = PERCENT_FEMALE(50),
