...
const struct SpeciesInfo gSpeciesInfoGen7[] =
{
    ...
    [SPECIES_CRABRAWLER] =
    {
        ...
        .evolutions = EVOLUTION({EVO_SPECIFIC_MAP, MAP_SHOAL_CAVE_LOW_TIDE_ICE_ROOM, SPECIES_CRABOMINABLE},
                                {EVO_LEVEL, 28, SPECIES_CRABOMINABLE},
    ...
    [SPECIES_ROCKRUFF] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL_ATK_GT_DEF, 25, SPECIES_LYCANROC_MIDDAY},
                                {EVO_LEVEL_ATK_LT_DEF, 25, SPECIES_LYCANROC_MIDNIGHT},
                                {EVO_LEVEL_ATK_EQ_DEF, 25, SPECIES_LYCANROC_DUSK}),
