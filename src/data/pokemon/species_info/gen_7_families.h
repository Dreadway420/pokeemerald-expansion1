...
const struct SpeciesInfo gSpeciesInfoGen7[] =
{
    ...
    [SPECIES_DECIDUEYE] =
    {
        ...
        .catchRate = 100,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 352 : 317,
        .evYield_Attack = 0,
        .genderRatio = PERCENT_FEMALE(12.5),
        .eggCycles = 15,
        .friendship = STANDARD_FRIENDSHIP,
    ...
    [SPECIES_TOUCANNON] =
    {
        ...
        .types = MON_TYPES(TYPE_NORMAL, TYPE_FLYING),
        .catchRate = 100,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 323 : 289,
        .evYield_Attack = 0,
    ...
    [SPECIES_YUNGOOS] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 27, SPECIES_GUMSHOOS}),
    },
    ...
    [SPECIES_VIKAVOLT] =
    {
        ...
        .types = MON_TYPES(TYPE_BUG, TYPE_ELECTRIC),
        .catchRate = 100,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 332 : 299,
        .evYield_SpAttack = 0,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 15,
        .friendship = STANDARD_FRIENDSHIP,
    ...
    [SPECIES_CRABRAWLER] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 28, SPECIES_CRABOMINABLE},
    ...
    [SPECIES_ROCKRUFF] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 25, SPECIES_LYCANROC_MIDDAY, CONDITIONS({IF_ATK_GT_DEF})},
                                {EVO_LEVEL, 25, SPECIES_LYCANROC_MIDNIGHT, CONDITIONS({IF_ATK_LT_DEF})},
                                {EVO_LEVEL, 25, SPECIES_LYCANROC_DUSK, CONDITIONS({IF_ATK_EQ_DEF})}),
    ...
    [SPECIES_LYCANROC_MIDDAY] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SOLID_ROCK, ABILITY_NONE, ABILITY_SAND_RUSH },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_LYCANROC_MIDNIGHT] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_NO_GUARD, ABILITY_NONE, ABILITY_SAND_FORCE },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Lycanroc"),
    ...
    [SPECIES_LYCANROC_DUSK] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_TOUGH_CLAWS, ABILITY_NONE, ABILITY_SAND_VEIL },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Lycanroc"),
    ...
    [SPECIES_MAREANIE] =
    {
        ...
        .abilities = { ABILITY_REGENERATOR, ABILITY_CORROSION, ABILITY_CORROSION },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_SHIINOTIC] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_RAIN_DISH, ABILITY_RAIN_DISH, ABILITY_EFFECT_SPORE },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_SALANDIT] =
    {
        ...
        .abilities = { ABILITY_MERCILESS, ABILITY_MERCILESS, ABILITY_CORROSION },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_TSAREENA] =
    {
        ...
        .types = MON_TYPES(TYPE_GRASS, TYPE_FIGHTING),
        .catchRate = 100,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 339 : 305,
        .evYield_Attack = 0,
    ...
    [SPECIES_PASSIMIAN] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_TRACE, ABILITY_NONE, ABILITY_RECEIVER },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_SANDYGAST] =
    {
        ...
        .abilities = { ABILITY_STORM_DRAIN, ABILITY_NONE, ABILITY_WATER_COMPACTION },
        .bodyColor = BODY_COLOR_BROWN,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 30, SPECIES_PALOSSAND}),
    },
...
#define MINIOR_CORE_SPECIES_INFO(Form, color, iconPal)          \
    ...
    [SPECIES_TAPU_KOKO] =
    {
        ...
        .catchRate = 100,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 379 : 341,
        .evYield_Speed = 0,
        .genderRatio = MON_GENDERLESS,
        .eggCycles = 15,
        .friendship = STANDARD_FRIENDSHIP,
    ...
    [SPECIES_NECROZMA_ULTRA] =
    {
        ...
        .catchRate = 255,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 501 : 450,
        .evYield_Attack = 0,
        .evYield_Speed = 0,
        .evYield_SpAttack = 0,
        .genderRatio = MON_GENDERLESS,
    ...
    [SPECIES_POIPOLE] =
    {
        ...
        .catchRate = 100,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 279 : 251,
        .evYield_Speed = 0,
        .genderRatio = MON_GENDERLESS,
        .eggCycles = 120,
        .friendship = 0,
    ...
    [SPECIES_MELTAN] =
    {
        ...
        .catchRate = 100,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 199 : 179,
        .evYield_Attack = 0,
        .genderRatio = MON_GENDERLESS,
        .eggCycles = 120,
        .friendship = 0,
