...
const struct SpeciesInfo gSpeciesInfoGen6[] =
{
    ...
    [SPECIES_FENNEKIN] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_NEUROFORCE, ABILITY_NONE, ABILITY_FUR_COAT },
    ...
    [SPECIES_DELPHOX] =
    {
        ...
        .catchRate = 70,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 355 : 319,
        .evYield_SpAttack = 0,
        .genderRatio = PERCENT_FEMALE(12.5),
        .eggCycles = 20,
        .friendship = STANDARD_FRIENDSHIP,
...
#define VIVILLON_MISC_INFO(form, color, iconPal)                                            \
        ...
        .catchRate = 70,                                                                    \
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 273 : 246,                            \
        .evYield_HP = 0,                                                                    \
        .evYield_Speed = 0,                                                                 \
        .evYield_SpAttack = 0,                                                              \
        .genderRatio = PERCENT_FEMALE(50),                                                  \
...
#define FLORGES_MISC_INFO(Form, iconPal)                                        \
        ...
        .types = MON_TYPES(TYPE_FAIRY),                                         \
        .catchRate = 70,                                                        \
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 367 : 329,                \
        .evYield_SpDefense = 0,                                                 \
        .genderRatio = MON_FEMALE,                                              \
        .eggCycles = 20,                                                        \
        .friendship = STANDARD_FRIENDSHIP,                                      \
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_AEGISLASH_SHIELD] =
    {
        ...
        .types = MON_TYPES(TYPE_STEEL, TYPE_GHOST),
        .catchRate = 70,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 332 : 311,
        .evYield_Defense = 0,
        .evYield_SpDefense = 0,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 20,
    ...
    [SPECIES_BINACLE] =
    {
        ...
        .abilities = { ABILITY_TOUGH_CLAWS, ABILITY_NONE, ABILITY_PICKPOCKET },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_HELIOPTILE] =
    {
        ...
        .abilities = { ABILITY_DRY_SKIN, ABILITY_SOLAR_POWER, ABILITY_SAND_VEIL },
    ...
    [SPECIES_GOOMY] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 26, SPECIES_SLIGGOO, CONDITIONS({IF_AMPED_NATURE})},
                                {EVO_LEVEL, 26, SPECIES_SLIGGOO_HISUI, CONDITIONS({IF_LOW_KEY_NATURE})}),
    },
    ...
    [SPECIES_ZYGARDE_10_AURA_BREAK] =
    {
        ...
        .types = MON_TYPES(TYPE_DRAGON, TYPE_GROUND),
        .catchRate = 70,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 323 : 291,
        .evYield_HP = 0,
        .genderRatio = MON_GENDERLESS,
        .eggCycles = 120,
        .friendship = 0,
    ...
    [SPECIES_ZYGARDE_COMPLETE] =
    {
        ...
        .types = MON_TYPES(TYPE_DRAGON, TYPE_GROUND),
        .catchRate = 70,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 470 : 424,
        .evYield_HP = 0,
        .genderRatio = MON_GENDERLESS,
        .eggCycles = 120,
        .friendship = 0,
