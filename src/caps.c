...
u32 GetCurrentLevelCap(void)
{
    static const u32 sLevelCapFlagMap[][2] =
    {
        ...
        {FLAG_ITEM_ROUTE_102_POTION, 9},
        {FLAG_UNUSED_0x020, 10},
        {FLAG_CHALLENGED_GRUNT, 12},
        {FLAG_BADGE01_GET, 15},
        {FLAG_RECOVERED_DEVON_GOODS, 18},
        {FLAG_DEFEATED_RIVAL_RUSTBORO, 19},
        {FLAG_RECEIVED_OLD_ROD, 21},
        {FLAG_HIDE_SLATEPORT_CITY_OCEANIC_MUSEUM_AQUA_GRUNTS, 26},
        {FLAG_BADGE02_GET, 30},
        {FLAG_ITEM_NEW_MAUVILLE_ESCAPE_ROPE, 32},
        {FLAG_BADGE03_GET, 35},
        {FLAG_BADGE04_GET, 41},
        {FLAG_BADGE05_GET, 52},
        {FLAG_BADGE06_GET, 62},
