...
#define B_FLAG_NO_BAG_USE           FLAG_ADVENTURE_STARTED     // If this flag is set, the ability to use the bag in battle is disabled.
...
#define B_BATTLE_SPEED 3 // Usage with a variable
